    ...
    <div id="specialmain">
      ...
      >
        <div className="bg-speciality-background">
          <div className="lg:grid lg:grid-cols-3 items-center lg:pl-12">
            ...
            <div className="lg:py-12  px-0 lg:px-0 max-w-5xl  mx-auto col-span-2  text-center lg:text-left lg:ml-8">
              ...
              <p className="text-neutral-500  mt-5   lg:text-left text-justify font-Helvetica lg:px-0 px-6 md:px-24">
