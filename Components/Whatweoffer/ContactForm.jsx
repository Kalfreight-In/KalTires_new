                  ...
                  >
                    <div className="w-full relative    appearance-none block h-full  bg-red-600 bg-opacity-30  z-10 rounded  leading-tight focus:outline-none text-white text-base">
                      <select
                        ...
                        className="w-full inherit block h-full appearance-none  bg-red-600 bg-opacity-2 0 focus:bg-red-600 focus:opacity-60 rounded  border py-3 px-4 mb-3 leading-tight focus:outline-none text-white text-base font-medium  p-2.5 "
