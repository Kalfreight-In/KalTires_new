            ...
            >
              {PerkBenifitsdata.map((data) => (
                ...
                >
                  ...
                  <p className="pt-16 pb-8 lg:text-sm font-normal  text-justify whitespace-pre-line px-4 font-Helvetica text-neutral-500 ">
                    {data.desc}
                  </p>
                </div>
              ))}
                    ...
                    <SwiperSlide key={data.id}>
                      <div className="bg-bg-white-1 text-center border border-perkbenefitsborder ">
                        ...
                        <p
                          ...
                          className="pt-12 pt pb-8 lg:text-sm font-normal  text-justify  whitespace-normal px-8 h-36 font-Helvetica text-neutral-500"
                        >
                          {data.desc}
                        </p>
                      </div>
