...
//         className=" bg-red-600 lg:pl-20  md:pt-20 pt-8 "
//         style={{
//           backgroundImage:
...
//                 <p className="text-neautralform  font-Helvetica md:text-lg text-xs font-normal  my-1 mb-3 ">
...
//               </div> */}
//               </div>
//               <div className="flex flex-wrap -mx-3 mb-6 md:mt-8 lg:mt-0 mt-8 justify-center">
//                 <div
