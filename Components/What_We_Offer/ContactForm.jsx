          ...
          <form className="w-fit " onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="flex flex-wrap -mx-3 mb-6 md:mt-8 lg:mt-0">
              ...
              >
                <input
                  onChange={(e) => setMessage(e.target.value)}
                  className="appearance-none block md:w-10/12 w-contactwidthmobile md:h-contactheighttab h-contactheightmobile bg-opacity-30 bg-red-600 placeholder-white border-white  text-white border rounded py-3 px-4 md:mb-3 mb-0 leading-tight focus:outline-non"
                  id="grid-first-name"
                  type="text"
                  value={message}
                  placeholder="Message"
